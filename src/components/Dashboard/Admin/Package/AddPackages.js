...
import { Box, Button, Center, Flex, Image, Input, Spinner, Switch, Text, useToast } from '@chakra-ui/react';
import Router from 'next/router';
import Categories from 'pages/dashboard/admin/categories';
import React, { useEffect, useState } from 'react';
import { MultiSelect } from "react-multi-select-component";
import { adminAddLivePackage, adminGetAddPackage, adminGetAllDrivers, adminGetProduct, adminSearchPackages } from 'services/admin-services';
...
return (
    <Box>
        <Box>
            <Box w={"full"} mb="30px" p={["18px", "44px"]} bg="#fff" >
                <Center>
