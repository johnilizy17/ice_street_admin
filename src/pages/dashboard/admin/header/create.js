...
import HeaderForm from "@/components/Dashboard/Admin/Adverts/HeaderForm";
	...
	return (
		<Box>
			...
			<Flex ml={["14px"]} mb={["29px"]} alignItems="center">
					<svg onClick={() => { Router.push("//dashboard/admin/header") }} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#000" class="bi bi-backspace-fill" viewBox="0 0 16 16">
