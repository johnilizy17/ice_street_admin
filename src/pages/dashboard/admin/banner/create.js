...
const BannerForm = dynamic(() => import('@/components/Dashboard/Admin/Adverts/BannerForm'), { ssr: false });
	...
	return (
		<Box>
			...
			<Text ml={["14px"]} mb={["29px"]}>
				Create Banner offerings. All promotions created are added to the promotion table and are made active for customers.
			</Text>
			<Container maxW="container.md" mx="0">
				{data.category ?

					<BannerForm data={data.category} />
					:
...
export default withAdmin(CreateBanner);
