...
import { Box, Button, Center, Flex, Heading, Image, Input, Spinner, Text, useToast } from '@chakra-ui/react';
...
export default function EditCategory({ datas, id }) {
    ...
    return (
        <Box>
            <Flex wrap={["wrap", "nowrap"]} justifyContent="space-between">
                <Box w={["full", "full", "80%"]} h="100%" mb="30px" p={["18px", "44px"]} bg="#fff" >
                    <Center>
